      ...
      <div class="my-bookstore">
        <main>
          <div class="content">
            ...
            <a href="admin/ranking/" class="btn">Ir al Ranking <i class="fas fa-arrow-right"></i></a>
          </div>
...
<div class="modal fade" id="libroModal" tabindex="-1" role="dialog" aria-labelledby="libroModalLabel" cerrar="cerrar" aria-hidden="true">
...
<script src="<?= constant('URL') ?>public/js/paginas/admin.home.js"></script>
