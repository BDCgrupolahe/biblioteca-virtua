...
<script src="<?= constant('URL') ?>public/js/paginas/usuarios.libros.js"></script>
    ...
    <div class="modal-dialog modal-right">
        <form id="form-autor-nuevo" action="javascript:;" class="needs-validation" novalidate method="post">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                    <button data-formulario="form-autor-nuevo" data-tipo="nuevo" type="button" class="btn btn-success btn-save-autores">Guardar</button>
                </div>
            </div>
        </form>
    </div>
