$(function () {
            ...
            <li>
                <figure class='book'>        
                    ...
                    <ul class='hardcover_front'>
                        <li>
                            <img src="${bookData.image}" alt="" width="100%" height="100%">
                        </li>
                        <li></li>
                    </ul>        
                    <!-- Pages -->        
                    <ul class='page'>
                        ...
                        <li>
                            ...
                            <a class="btn btn-delete-favo" data-id="${btoa(btoa(bookData.id_agregacion))}" data-book-title="${bookData.title}">Eliminar</a>
                        </li>
                        <li></li>
                        <li></li>
                        <li></li>
                    ...
                    <figcaption>
                        ...
                        <p><h6>Fecha de agregación:</h6>${bookData.fechaagrega}</p>
                        <br>
                    </figcaption>
                </figure>
            </li>`;
  ...
  async function cardsEventos() {
    try {
      let peticion = await fetch(servidor + `usuarios/loslibrosfavoritos`);
      ...
      response.forEach((item, index) => {
        const bookData = {
          ...
          title: item.titulo_libro,
          author: item.nombre_autor,
          description: item.editorial_libro,
